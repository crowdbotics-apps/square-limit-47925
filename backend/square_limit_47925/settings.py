"""
Django settings for square_limit_47925 project.
...
ROOT_URLCONF = 'square_limit_47925.urls'
...
WSGI_APPLICATION = 'square_limit_47925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_limit_47925 API",
    "DESCRIPTION": "API documentation for square_limit_47925 App",
    "VERSION": "v1",
}
